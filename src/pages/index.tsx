  ...
  function searchFilter() {
    ...
    searchTerms.forEach((term) => {
      if (term.includes("t+")) {
        ...
        const searchTerm = term.replace("au-", "");
        filterData = filterData.filter(
          (paper) => !paper.authors.toLowerCase().includes(searchTerm),
        );
      }
    });
    setData(filterData);
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#2e026d] to-[#15162c]">
        <h1 className="text-4xl font-bold text-white">Open Open Access</h1>
        ...
        <div className="flex flex-col items-center justify-center gap-4 pt-4">
          {!isSectionCollapsed && (
            <>
              ...
              <p className="text-white">Separate all terms by space</p>
            </>
          )}
        </div>
        ...
        {/* found X out of Y.... */}
        <p className="pt-4 text-white">{`Found ${data.length} out of ${ogdata.length} papers`}</p>
